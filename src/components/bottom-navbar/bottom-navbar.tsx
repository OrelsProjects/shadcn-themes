...
export function BottomNavbar() {
  return (
    ...
    >
      <Card className="w-fit h-16 bg-background/80 backdrop-blur-md border border-border/80 shadow-sm px-6 py-2 flex items-center gap-4 overflow-visible max-md:overflow-x-auto">
        <CopyCode />
        <ThemesDialog />
        <Randomize />
